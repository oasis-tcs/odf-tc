...
TEST_NAMES=("rounded-rectangle-red" "rectangleWithText" "DefaultSquare" "tdf95662-complex" "tdf95662" "frames-without-wrap" "floating_image_as_character" "frames-without-wrap" "tdf146264" "floating" "spec-fragment" "default-styles" "tdf156093-image" "RedSquare" "tdf156093-image_alignment")
ODF_VERSION=odf1.4
