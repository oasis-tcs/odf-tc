...
// TEST_NAMES=("frames-without-wrap" "floating_image_as_character" "frames-without-wrap" "tdf146264" "floating" "spec-fragment" "default-styles" "tdf156093-image")
TEST_NAMES=("tdf156093-image")
ODF_VERSION=odf1.4
