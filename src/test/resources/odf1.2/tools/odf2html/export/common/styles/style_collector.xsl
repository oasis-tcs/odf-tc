...
-->
	...
	<xsl:template name="write-collected-styles">
		...
		<xsl:for-each select="$globalData/all-doc-styles/style">
			...
			<xsl:message>
				style:family="
				<xsl:value-of select="current()/@style:family" />
				"&gt;
			</xsl:message>
			<xsl:message>
				style:name="
				<xsl:value-of select="current()/@style:name" />
				"
			</xsl:message>
               ...
               or
				...
				<xsl:element name="style" namespace="">
					...
					<xsl:attribute name="style:name">
						<xsl:value-of select="concat($style/@style:name, '_borderStart')" />
					</xsl:attribute>
				...
				<xsl:element name="style" namespace="">
					...
					<xsl:attribute name="mergedBorders">
				...
				<xsl:element name="style" namespace="">
					<xsl:copy-of select="$style/@style:family" />
					<xsl:attribute name="style:name">
						<xsl:value-of select="concat($style/@style:name, '_borderEnd')" />
					</xsl:attribute>
					<xsl:element name="final-properties" namespace="">
